...
const navItems: { label: string; path: string; icon: any; roles: string[] }[] = [
  ...
  { label: "CEO Dashboard", path: "/ceo-dashboard", icon: Crown, roles: ["SUPER_ADMIN"] },
  ...
  { label: "Analytics", path: "/analytics", icon: BarChart4, roles: ["SUPER_ADMIN", "DIRECTOR", "OPERATIONS_MANAGER", "SALES_MANAGER", "HR"] },
  ...
  { label: "Lead Studio", path: "/lead-studio", icon: Radio, roles: ["SUPER_ADMIN", "DIRECTOR", "OPERATIONS_MANAGER", "SALES_MANAGER", "HR"] },
