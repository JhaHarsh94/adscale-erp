...
import { FolderKanban, Plus, RefreshCcw, Trash2 } from "lucide-react";
...
export default function ProjectsPage() {
  ...
  async function deleteProject(id: string) { try { await apiClient.delete(`/projects/${id}`); setMessage("Project deleted"); await load(); } catch { setMessage("Failed to delete project"); } }
